	...
	public void run() {
		try {
			synchronized (lock) {
				...
				Scanner sc = new Scanner(new File("src/application/PlayGame.fxml"));
				Scanner sc2 = new Scanner(new File("src/application/PlayGameController.java"));
				...
				Thread.sleep(10);
				lock.flag = 3;
				System.out.println("flat2: "+lock.flag);
				lock.notifyAll();
				sc.close();
				sc2.close();
			}
